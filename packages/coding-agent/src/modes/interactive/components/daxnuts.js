...
exports.DaxnutsComponent = void 0;
...
function buildImage() {
    ...
    for (let row = 0; row < HEIGHT; row += 2) {
        ...
        for (let x = 0; x < WIDTH; x++) {
            ...
            const bottom = (_b = (_a = pixels[row + 1]) === null || _a === void 0 ? void 0 : _a[x]) !== null && _b !== void 0 ? _b : top;
...
exports.DaxnutsComponent = DaxnutsComponent;
