...
class FooterComponent {
    ...
    render(width) {
        ...
        const contextTokens = lastAssistantMessage
            ...
            : 0;
        const contextWindow = ((_a = state.model) === null || _a === void 0 ? void 0 : _a.contextWindow) || 0;
        ...
        const modelName = ((_b = state.model) === null || _b === void 0 ? void 0 : _b.id) || "no-model";
        let statsLeftWidth = (0, pi_tui_1.visibleWidth)(statsLeft);
        ...
        if ((_c = state.model) === null || _c === void 0 ? void 0 : _c.reasoning) {
        ...
        const rightSideWidth = (0, pi_tui_1.visibleWidth)(rightSide);
        ...
        const dimStatsLeft = theme_js_1.theme.fg("dim", statsLeft);
        const remainder = statsLine.slice(statsLeft.length); // padding + rightSide
        const dimRemainder = theme_js_1.theme.fg("dim", remainder);
        const lines = [theme_js_1.theme.fg("dim", pwd), dimStatsLeft + dimRemainder];
