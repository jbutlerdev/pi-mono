 ...
 */
class SelectSubmenu extends pi_tui_1.Container {
    selectList;
    constructor(title, description, options, currentValue, onSelect, onCancel, onSelectionChange) {
        super();
        // Title
        this.addChild(new pi_tui_1.Text(theme_js_1.theme.bold(theme_js_1.theme.fg("accent", title)), 0, 0));
        // Description
        if (description) {
            this.addChild(new pi_tui_1.Spacer(1));
            this.addChild(new pi_tui_1.Text(theme_js_1.theme.fg("muted", description), 0, 0));
        }
        // Spacer
        this.addChild(new pi_tui_1.Spacer(1));
        // Select list
        this.selectList = new pi_tui_1.SelectList(options, Math.min(options.length, 10), (0, theme_js_1.getSelectListTheme)());
        ...
        // Hint
        this.addChild(new pi_tui_1.Spacer(1));
        this.addChild(new pi_tui_1.Text(theme_js_1.theme.fg("dim", "  Enter to select · Esc to go back"), 0, 0));
    }
    handleInput(data) {
 ...
 */
class SettingsSelectorComponent extends pi_tui_1.Container {
    settingsList;
    constructor(config, callbacks) {
        super();
        const supportsImages = (0, pi_tui_1.getCapabilities)().images;
        const items = [
            {
                id: "autocompact",
                label: "Auto-compact",
        ...
        this.settingsList = new pi_tui_1.SettingsList(items, 10, (0, theme_js_1.getSettingsListTheme)(), (id, newValue) => {
            switch (id) {
                case "autocompact":
