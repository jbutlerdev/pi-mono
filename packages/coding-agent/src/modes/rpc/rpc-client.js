...
class RpcClient {
    ...
    async start() {
        ...
        const cliPath = (_b = this.options.cliPath) !== null && _b !== void 0 ? _b : "dist/cli.js";
        const args = ["--mode", "rpc"];
        ...
        this.process = (0, node_child_process_1.spawn)("node", [cliPath, ...args], {
    ...
    async stop() {
        ...
        await new Promise((resolve) => {
            ...
            (_a = this.process) === null || _a === void 0 ? void 0 : _a.on("exit", () => {
    ...
    async send(command) {
        ...
        const fullCommand = Object.assign(Object.assign({}, command), { id });
        return new Promise((resolve, reject) => {
