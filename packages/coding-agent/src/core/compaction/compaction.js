...
exports.getLastAssistantUsage = getLastAssistantUsage;
exports.estimateContextTokens = estimateContextTokens;
exports.shouldCompact = shouldCompact;
exports.estimateTokens = estimateTokens;
exports.findTurnStartIndex = findTurnStartIndex;
...
function extractFileOperations(messages, entries, prevCompactionIndex) {
    const fileOps = (0, utils_js_1.createFileOps)();
    ...
    for (const msg of messages) {
        (0, utils_js_1.extractFileOpsFromMessage)(msg, fileOps);
    }
    return fileOps;
}
// ============================================================================
...
async function generateSummary(currentMessages, model, reserveTokens, apiKey, signal, customInstructions, previousSummary) {
    ...
    const llmMessages = (0, messages_js_1.convertToLlm)(currentMessages);
    const conversationText = (0, utils_js_1.serializeConversation)(llmMessages);
    ...
    const response = await (0, pi_ai_1.completeSimple)(model, { systemPrompt: utils_js_1.SUMMARIZATION_SYSTEM_PROMPT, messages: summarizationMessages }, { maxTokens, signal, apiKey, reasoning: "high" });
...
function prepareCompaction(pathEntries, settings) {
    ...
    if (!(firstKeptEntry === null || firstKeptEntry === void 0 ? void 0 : firstKeptEntry.id)) {
...
async function compact(preparation, model, apiKey, customInstructions, signal) {
    ...
    const { readFiles, modifiedFiles } = (0, utils_js_1.computeFileLists)(fileOps);
...
async function generateTurnPrefixSummary(messages, model, reserveTokens, apiKey, signal) {
    ...
    const llmMessages = (0, messages_js_1.convertToLlm)(messages);
    const conversationText = (0, utils_js_1.serializeConversation)(llmMessages);
    ...
    const response = await (0, pi_ai_1.completeSimple)(model, { systemPrompt: utils_js_1.SUMMARIZATION_SYSTEM_PROMPT, messages: summarizationMessages }, { maxTokens, signal, apiKey });
    if (response.stopReason === "error") {
