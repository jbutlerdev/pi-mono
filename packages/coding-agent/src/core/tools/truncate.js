...
function truncateHead(content, options = {}) {
    var _a, _b;
    const maxLines = (_a = options.maxLines) !== null && _a !== void 0 ? _a : exports.DEFAULT_MAX_LINES;
    const maxBytes = (_b = options.maxBytes) !== null && _b !== void 0 ? _b : exports.DEFAULT_MAX_BYTES;
 ...
 */
function truncateLine(line, maxChars = exports.GREP_MAX_LINE_LENGTH) {
