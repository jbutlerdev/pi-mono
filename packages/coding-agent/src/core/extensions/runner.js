...
class ExtensionRunner {
    ...
    createCommandContext() {
        return Object.assign(Object.assign({}, this.createContext()), { waitForIdle: () => this.waitForIdleFn(), newSession: (options) => this.newSessionHandler(options), fork: (entryId) => this.forkHandler(entryId), navigateTree: (targetId, options) => this.navigateTreeHandler(targetId, options), switchSession: (sessionPath) => this.switchSessionHandler(sessionPath) });
    }
        ...
        for (const ext of this.extensions) {
            ...
            for (const handler of handlers) {
                try {
                    ...
                    const handlerResult = await handler(event, ctx);
                    const result = handlerResult;
                    if ((_a = result === null || result === void 0 ? void 0 : result.skillPaths) === null || _a === void 0 ? void 0 : _a.length) {
                        skillPaths.push(...result.skillPaths.map((path) => ({ path, extensionPath: ext.path })));
                    }
                    if ((_b = result === null || result === void 0 ? void 0 : result.promptPaths) === null || _b === void 0 ? void 0 : _b.length) {
                        promptPaths.push(...result.promptPaths.map((path) => ({ path, extensionPath: ext.path })));
                    }
                    if ((_c = result === null || result === void 0 ? void 0 : result.themePaths) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    async emitInput(text, images, source) {
        ...
        for (const ext of this.extensions) {
            for (const handler of (_a = ext.handlers.get("input")) !== null && _a !== void 0 ? _a : []) {
                try {
                    ...
                    if ((result === null || result === void 0 ? void 0 : result.action) === "transform") {
                        ...
                        currentImages = (_b = result.images) !== null && _b !== void 0 ? _b : currentImages;
                    }
                }
                catch (err) {
                    this.emitError({
