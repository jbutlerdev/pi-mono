...
function buildSystemPrompt(options = {}) {
    ...
    const contextFiles = providedContextFiles !== null && providedContextFiles !== void 0 ? providedContextFiles : [];
    const skills = providedSkills !== null && providedSkills !== void 0 ? providedSkills : [];
    if (customPrompt) {
    ...
    const readmePath = (0, config_js_1.getReadmePath)();
    const docsPath = (0, config_js_1.getDocsPath)();
    const examplesPath = (0, config_js_1.getExamplesPath)();
